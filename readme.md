...
Para ejecutar tus aplicaciones desarrolladas directamente en tu celular, debes configurar Android o iOS en modo desarrollador, para lo cual hay que hacer lo siguientevv: 
...
**`ionic cap run android -l --external --host=192.168.100.13 --port=8100 --target UOUG4PS8GYPBXKZH`**
