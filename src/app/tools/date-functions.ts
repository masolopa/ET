...
// Función para convertir Date a string con formato YYYY-MM-DD
...
// Convierte una cadena de fecha con el formato YYYY-MM-DD en un objeto Date
export const convertStringToDate = (dateString: string): Date => {
  try {
    ...
    return new Date(); // Retorna la fecha actual si hay un error
  }
}
